...
const TABLE_FILTERS = [
  {
    ...
    filterFunc: (datum: ISchedule, value) => datum.fullName.indexOf(value) > -1,
  },
  {
  ...
  },
  {
    ...
    filterFunc: (datum: ISchedule, value) => datum.email.indexOf(value) > -1,
  },
...
const mockData = Array(30)
  ...
  .map((_, idx) => ({
    ...
    action: <Actions idx={idx} path={PATH_DASHBOARD.schedule.root} />,
  }));

const PageAction = () => {
  return (
    <Link component={RouterLink} to={PATH_DASHBOARD.schedule.createNew}>
